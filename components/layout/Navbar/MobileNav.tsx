                ...
                {status === "authenticated" ? (
                  <>
                    <Link
                      href="/dashboard"
                      onClick={() => setIsOpen(false)}
                      className="block w-full border border-[#05203C] text-[#05203C] py-3 rounded text-center text-xs font-bold uppercase tracking-wider"
                    >
                      Dashboard
                    </Link>
                    <button
                      onClick={() => { signOut({ callbackUrl: "/" }); setIsOpen(false); }}
                      className="block w-full bg-[#BE1E2D] text-white py-3 rounded text-center text-xs font-bold uppercase tracking-wider hover:bg-[#9e1825] transition-colors"
                    >
                      Sign Out
                    </button>
                  </>
                  ...
                  <>
                    ...
                    <Link
                      href="/apply"
                      onClick={() => setIsOpen(false)}
                      className="block w-full bg-[#05203C] text-white py-3 rounded text-center text-xs font-bold uppercase tracking-wider hover:bg-[#082a4d] transition-colors"
                    >
                      Apply Now
                    </Link>
                  </>
