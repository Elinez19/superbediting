    ...
    <footer className="bg-[#05203C] text-white pt-20 pb-10 overflow-hidden relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="inline-block mb-6">
              <div className="flex items-center gap-1.2 font-bold text-2xl text-white whitespace-nowrap">
                <span className="text-[#0051A1]">SUPERB</span>EDITING
            ...
            <p className="text-white/70 text-base leading-relaxed mb-8 max-w-md">
              Africa&apos;s premier research writing and editing service. 
              We empower scholars and researchers with precision, clarity, and the 
              academic excellence needed to succeed in global publication.
            </p>
            <div className="flex gap-4">
              {socialLinks.map((social, idx) => (
                <motion.a
                  key={idx}
                  href={social.href}
                  whileHover={{ y: -5, backgroundColor: "#0051A1" }}
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-lg py-3 px-4 text-sm focus:outline-none focus:border-[#0051A1] transition-colors pr-12"
                />
                <button className="absolute right-2 top-1/2 -translate-y-1/2 bg-[#0051A1] p-2 rounded-md hover:bg-red-700 transition-colors">
                  <Send size={16} />
                </button>
              </div>
            </div>
        ...
        <div className="pt-10 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white/40">
          <p>© {currentYear} Superb Editing. All rights reserved.</p>
