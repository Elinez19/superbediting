      ...
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16">
          ...
          >
            ...
            >
              Ready to elevate your research? Whether you need thesis editing, manuscript polishing, or publication support, our academic experts are here to help.
            </motion.p>
            ...
            <div className="space-y-8 mb-12">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-[#05203C]">hello@superbediting.com</p>
                </div>
              </motion.div>
            ...
            <form className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <select className="w-full bg-white border border-gray-200 rounded-2xl px-6 py-4 focus:outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition-all text-gray-900 appearance-none">
                  <option>Thesis & Dissertation Editing</option>
                  <option>Journal Manuscript Support</option>
                  <option>Research Proposal Writing</option>
                  <option>Proofreading & Formatting</option>
